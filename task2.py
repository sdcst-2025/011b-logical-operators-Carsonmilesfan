...
if round(x, 4) == round(x, 1) and round(y, 4) == round(y, 1):
    print("your number is both a perfect square and divisible by 2.")
elif round(x, 4) == round(x, 1):
    print("your number is only a perfect square.")
elif round(y, 4) == round(y, 1):
